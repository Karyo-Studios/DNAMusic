...
export const helpMessages = {
        introduction: [
            ...
            },
            {
                ...
                description: 'A codon is the basic unit of information in DNA. Each three-letter codon corresponds to one of 20 different amino acids, which are the building blocks of proteins. In this way, the DNA sequence provides the blueprint for making proteins, which are the machinery of the cell.\n\nThe special codons are "start" codons and "stop" codons. A start codon (ATG) signals the beginning of a protein-coding sequence, while three different stop codons (TGA, TAG, TAA) signal its end.',
            },
            {
                name: 'Codon Wheel',
